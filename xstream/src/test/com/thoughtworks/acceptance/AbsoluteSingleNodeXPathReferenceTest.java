 ...
 * AbsolutSingleNodeXPathCircularReferenceTest, AbsolutSingleNodeXPathDuplicateReferenceTest
 * and AbsolutSingleNodeXPathReplacedReferenceTest.
 */
...
public class AbsoluteSingleNodeXPathReferenceTest extends AbstractReferenceTest {
    ...
    public void testTree() {
        ...
        String expected = ""
            ...
            + "    <name>Y</name>\n"
            + "    <left>\n"
            + "      <name reference=\"/elem[1]/name[1]\"/>\n"
            + "    </left>\n"
            + "  </left>\n"
            + "  <right>\n"
            + "    <name>Z</name>\n"
            + "    <left reference=\"/elem[1]/left[1]/left[1]\"/>\n"
            + "    <right>\n"
            + "      <name reference=\"/elem[1]/left[1]/name[1]\"/>\n"
            + "    </right>\n"
            + "  </right>\n"
            + "</elem>";
