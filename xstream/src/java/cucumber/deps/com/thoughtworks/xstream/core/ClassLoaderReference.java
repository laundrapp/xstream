...
public final class ClassLoaderReference {
    ...
    public void setReference(ClassLoader reference) {
        this.reference = reference instanceof cucumber.deps.com.thoughtworks.xstream.core.util.ClassLoaderReference
                ? ((cucumber.deps.com.thoughtworks.xstream.core.util.ClassLoaderReference)reference)
