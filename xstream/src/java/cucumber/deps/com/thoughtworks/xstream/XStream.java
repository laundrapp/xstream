...
import cucumber.deps.com.thoughtworks.xstream.converters.basic.BigDecimalConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.basic.BigIntegerConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.basic.CharConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.basic.FloatConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.basic.NullConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.basic.URIConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.basic.URLConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.collections.CharArrayConverter;
...
import cucumber.deps.com.thoughtworks.xstream.converters.collections.SingletonCollectionConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.collections.SingletonMapConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.collections.TreeMapConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.collections.TreeSetConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.DynamicProxyConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.EncodedByteArrayConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.FileConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.GregorianCalendarConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.JavaClassConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.JavaFieldConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.JavaMethodConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.LocaleConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.SqlDateConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.SqlTimeConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.SqlTimestampConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.extended.TextAttributeConverter;
import cucumber.deps.com.thoughtworks.xstream.converters.reflection.ExternalizableConverter;
...
import cucumber.deps.com.thoughtworks.xstream.core.TreeMarshallingStrategy;
import cucumber.deps.com.thoughtworks.xstream.core.util.CompositeClassLoader;
import cucumber.deps.com.thoughtworks.xstream.core.util.CustomObjectInputStream;
import cucumber.deps.com.thoughtworks.xstream.core.util.CustomObjectOutputStream;
import cucumber.deps.com.thoughtworks.xstream.core.util.SelfStreamingInstanceChecker;
...
import cucumber.deps.com.thoughtworks.xstream.io.StatefulWriter;
import cucumber.deps.com.thoughtworks.xstream.io.xml.XppDriver;
import cucumber.deps.com.thoughtworks.xstream.mapper.AnnotationConfiguration;
import cucumber.deps.com.thoughtworks.xstream.mapper.ArrayMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.AttributeAliasingMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.AttributeMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.CachingMapper;
...
import cucumber.deps.com.thoughtworks.xstream.mapper.FieldAliasingMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.ImmutableTypesMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.ImplicitCollectionMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.LocalConversionMapper;
...
import cucumber.deps.com.thoughtworks.xstream.mapper.PackageAliasingMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.SecurityMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.SystemAttributeAliasingMapper;
import cucumber.deps.com.thoughtworks.xstream.mapper.XStream11XmlFriendlyMapper;
...
import cucumber.deps.com.thoughtworks.xstream.security.NoPermission;
...
import cucumber.deps.com.thoughtworks.xstream.security.TypeHierarchyPermission;
 ...
 * 
 * <p>
 * XStream contains a map of {@link cucumber.deps.com.thoughtworks.xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link cucumber.deps.com.thoughtworks.xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link cucumber.deps.com.thoughtworks.xstream.converters.Converter} interface.
 * </p>
 * 
 * <p>
 * <hr>
 ...
 * {@link cucumber.deps.com.thoughtworks.xstream.converters.reflection.ReflectionConverter} as the fallback
 * converter.
 * </p>
 * 
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "cucumber.deps.com.thoughtworks.xstream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "cucumber.deps.com.thoughtworks.xstream.mapper.EnumMapper", new Class[]{Mapper.class},
                new Object[]{mapper});
        }
    ...
    private Mapper buildMapperDynamically(String className, Class[] constructorParamTypes,
        ...
        try {
            ...
            throw new cucumber.deps.com.thoughtworks.xstream.InitializationException(
    ...
    protected void setupConverters() {
        ...
        if (JVM.is14()) {
            ...
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.extended.ThrowableConverter",
                PRIORITY_NORMAL, new Class[]{ConverterLookup.class},
                new Object[]{converterLookup});
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.extended.StackTraceElementConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.extended.CurrencyConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.extended.RegexPatternConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.extended.CharsetConverter",
                PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            ...
            if (JVM.loadClassForName("javax.xml.datatype.Duration") != null) {
                registerConverterDynamically(
                    "cucumber.deps.com.thoughtworks.xstream.converters.extended.DurationConverter",
                    PRIORITY_NORMAL, null, null);
            }
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                null, null);
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.basic.StringBuilderConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "cucumber.deps.com.thoughtworks.xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }
    ...
    public void alias(String name, Class type) {
        if (classAliasingMapper == null) {
            throw new cucumber.deps.com.thoughtworks.xstream.InitializationException("No "
     ...
     * </p>
     * 
     * @see #createObjectOutputStream(cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamWriter,
     *      String)
     * @see #createObjectInputStream(cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
    ...
    /**
     * @deprecated As of 1.3, use {@link cucumber.deps.com.thoughtworks.xstream.InitializationException}
     *             instead
     */
    public static class InitializationException extends XStreamException {
        /**
         * @deprecated As of 1.3, use
         *             {@link cucumber.deps.com.thoughtworks.xstream.InitializationException#InitializationException(String, Throwable)}
         *             instead
         */
        ...
        /**
         * @deprecated As of 1.3, use
         *             {@link cucumber.deps.com.thoughtworks.xstream.InitializationException#InitializationException(String)}
         *             instead
         */
