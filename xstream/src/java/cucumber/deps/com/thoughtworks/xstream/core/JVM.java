...
public class JVM implements Caching {
    ...
    static {
        ...
        if (canUseSunUnsafeReflectionProvider()) {
            Class cls = loadClassForName("cucumber.deps.com.thoughtworks.xstream.converters.reflection.SunUnsafeReflectionProvider");
            if (cls != null) {
                try {
                    ...
                    if (cls == null) {
                        cls = loadClassForName("cucumber.deps.com.thoughtworks.xstream.converters.reflection.SunLimitedUnsafeReflectionProvider");
                    }
                    type = cls;
                } catch (ObjectAccessException e) {
                }
