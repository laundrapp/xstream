...
import cucumber.deps.com.thoughtworks.xstream.core.util.FastField;
...
public class JavaBeanConverter implements Converter {
    ...
    /**
     * @deprecated As of 1.3, use {@link #JavaBeanConverter(Mapper)} and {@link cucumber.deps.com.thoughtworks.xstream.XStream#aliasAttribute(String, String)}
     */
