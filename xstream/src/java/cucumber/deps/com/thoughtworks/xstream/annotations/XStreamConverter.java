 ...
 */
package cucumber.deps.com.thoughtworks.xstream.annotations;
 ...
 * <ul>
 * <li>{@link cucumber.deps.com.thoughtworks.xstream.mapper.Mapper}: The current mapper chain of the XStream
 * instance.</li>
 * <li>{@link cucumber.deps.com.thoughtworks.xstream.core.ClassLoaderReference}: The reference to the class
 * loader used by the XStream instance to deserialize the objects.</li>
 * <li>{@link cucumber.deps.com.thoughtworks.xstream.converters.reflection.ReflectionProvider}: The reflection
 * provider used by the reflection based converters of the current XStream instance.</li>
 * <li>{@link cucumber.deps.com.thoughtworks.xstream.converters.ConverterLookup}: The lookup for converters
 ...
 * {@link cucumber.deps.com.thoughtworks.xstream.annotations.XStreamConverters} or {@link #useImplicitType()}
 * == false.</li>
 * <li>{@link cucumber.deps.com.thoughtworks.xstream.core.JVM}: Utility e.g. to load classes.</li>
 ...
 * {@link cucumber.deps.com.thoughtworks.xstream.converters.ConverterMatcher} as well as
 * {@link cucumber.deps.com.thoughtworks.xstream.converters.SingleValueConverter} extend this interface. The
 * {@link cucumber.deps.com.thoughtworks.xstream.mapper.AnnotationMapper} can only handle these two
