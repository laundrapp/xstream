...
@interface CucumberDepsComThoughtworksXstreamMapperMapper : NSObject

@end

@interface CucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping : NSObject

@end

@implementation CucumberDepsComThoughtworksXstreamMapperMapper
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LCucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping;", 0x401, 15, 5, -1, -1, -1, -1 },
    { NULL, "Z", 0x401, 16, 5, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 17, 18, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 17, 1, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 19, 3, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersConverter;", 0x401, 20, 5, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamMapperMapper;", 0x401, 21, 1, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 17, 22, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x401, 9, 5, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x401, 10, 5, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 19, 5, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x401, 19, 23, -1, -1, -1, -1 },
  };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LCucumberDepsComThoughtworksXstreamMapperMapper;" };
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamMapperMapper_Null = { "Null", "cucumber.deps.com.thoughtworks.xstream.mapper", ptrTable, methods, NULL, 7, 0x9, 1, 0, 0, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamMapperMapper_Null;
}

@end

void CucumberDepsComThoughtworksXstreamMapperMapper_Null_init(CucumberDepsComThoughtworksXstreamMapperMapper_Null *self) {
  NSObject_init(self);
}

CucumberDepsComThoughtworksXstreamMapperMapper_Null *new_CucumberDepsComThoughtworksXstreamMapperMapper_Null_init() {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamMapperMapper_Null, init)
}

CucumberDepsComThoughtworksXstreamMapperMapper_Null *create_CucumberDepsComThoughtworksXstreamMapperMapper_Null_init() {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamMapperMapper_Null, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamMapperMapper_Null)

@implementation CucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LCucumberDepsComThoughtworksXstreamMapperMapper;" };
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping = { "ImplicitCollectionMapping", "cucumber.deps.com.thoughtworks.xstream.mapper", ptrTable, methods, NULL, 7, 0x609, 4, 0, 0, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping)
