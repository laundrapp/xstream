...
#pragma push_macro("INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream")
#ifdef RESTRICT_CucumberDepsComThoughtworksXstreamXStream
#define INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream 0
#else
#define INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream 1
#endif
#undef RESTRICT_CucumberDepsComThoughtworksXstreamXStream
...
#if !defined (CucumberDepsComThoughtworksXstreamXStream_) && (INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream || defined(INCLUDE_CucumberDepsComThoughtworksXstreamXStream))
#define CucumberDepsComThoughtworksXstreamXStream_

@class CucumberDepsComThoughtworksXstreamCoreClassLoaderReference;
@class CucumberDepsComThoughtworksXstreamMapperMapperWrapper;
@class IOSClass;
...
@protocol CucumberDepsComThoughtworksXstreamMarshallingStrategy;
...
@endcode
 ...
 <p>
  XStream contains a map of <code>cucumber.deps.com.thoughtworks.xstream.converters.Converter</code> instances, each
 ...
 <p>
  ...
  non-standard converters are supplied in the <code>cucumber.deps.com.thoughtworks.xstream.converters.extended</code>
  package and you can create your own by implementing the 
 <code>cucumber.deps.com.thoughtworks.xstream.converters.Converter</code> interface. 
 </p>
...
@endcode
 ...
 <code>cucumber.deps.com.thoughtworks.xstream.converters.reflection.ReflectionConverter</code> as the fallback
  converter. 
 </p>
 ...
 */
@interface CucumberDepsComThoughtworksXstreamXStream : NSObject
...
@endcode
 - seealso: #createObjectOutputStream(cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamWriter,
      String)
 @since 1.0.3
 */
...
/*!
 @brief Creates an ObjectInputStream that deserializes a stream of objects from an InputStream
  using XStream.
 - seealso: #createObjectInputStream(cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamReader)
 - seealso: #createObjectOutputStream(cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamWriter,
      String)
 @since 1.3
 */
 ...
 */
- (id<CucumberDepsComThoughtworksXstreamConvertersDataHolder>)newDataHolder OBJC_METHOD_FAMILY_NONE;
...
J2OBJC_STATIC_INIT(CucumberDepsComThoughtworksXstreamXStream)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_NO_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_NO_REFERENCES 1001
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, NO_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_ID_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_ID_REFERENCES 1002
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, ID_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_XPATH_RELATIVE_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_XPATH_RELATIVE_REFERENCES 1003
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, XPATH_RELATIVE_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_XPATH_ABSOLUTE_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_XPATH_ABSOLUTE_REFERENCES 1004
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, XPATH_ABSOLUTE_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_SINGLE_NODE_XPATH_RELATIVE_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_SINGLE_NODE_XPATH_RELATIVE_REFERENCES 1005
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, SINGLE_NODE_XPATH_RELATIVE_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_SINGLE_NODE_XPATH_ABSOLUTE_REFERENCES(void);
#define CucumberDepsComThoughtworksXstreamXStream_SINGLE_NODE_XPATH_ABSOLUTE_REFERENCES 1006
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, SINGLE_NODE_XPATH_ABSOLUTE_REFERENCES, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_PRIORITY_VERY_HIGH(void);
#define CucumberDepsComThoughtworksXstreamXStream_PRIORITY_VERY_HIGH 10000
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, PRIORITY_VERY_HIGH, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_PRIORITY_NORMAL(void);
#define CucumberDepsComThoughtworksXstreamXStream_PRIORITY_NORMAL 0
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, PRIORITY_NORMAL, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_PRIORITY_LOW(void);
#define CucumberDepsComThoughtworksXstreamXStream_PRIORITY_LOW -10
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, PRIORITY_LOW, jint)

inline jint CucumberDepsComThoughtworksXstreamXStream_get_PRIORITY_VERY_LOW(void);
#define CucumberDepsComThoughtworksXstreamXStream_PRIORITY_VERY_LOW -20
J2OBJC_STATIC_FIELD_CONSTANT(CucumberDepsComThoughtworksXstreamXStream, PRIORITY_VERY_LOW, jint)

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamXStream_init(CucumberDepsComThoughtworksXstreamXStream *self);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *new_CucumberDepsComThoughtworksXstreamXStream_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *create_CucumberDepsComThoughtworksXstreamXStream_init(void);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider_(CucumberDepsComThoughtworksXstreamXStream *self, id<CucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider> reflectionProvider);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *new_CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider_(id<CucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider> reflectionProvider) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *create_CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider_(id<CucumberDepsComThoughtworksXstreamConvertersReflectionReflectionProvider> reflectionProvider);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver_(CucumberDepsComThoughtworksXstreamXStream *self, id<CucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver> hierarchicalStreamDriver);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *new_CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver_(id<CucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver> hierarchicalStreamDriver) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream *create_CucumberDepsComThoughtworksXstreamXStream_initWithCucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver_(id<CucumberDepsComThoughtworksXstreamIoHierarchicalStreamDriver> hierarchicalStreamDriver);
...
J2OBJC_TYPE_LITERAL_HEADER(CucumberDepsComThoughtworksXstreamXStream)

#endif

#if !defined (CucumberDepsComThoughtworksXstreamXStream_InitializationException_) && (INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream || defined(INCLUDE_CucumberDepsComThoughtworksXstreamXStream_InitializationException))
#define CucumberDepsComThoughtworksXstreamXStream_InitializationException_
...
/*!
 */
@interface CucumberDepsComThoughtworksXstreamXStream_InitializationException : CucumberDepsComThoughtworksXstreamXStreamException
...
J2OBJC_EMPTY_STATIC_INIT(CucumberDepsComThoughtworksXstreamXStream_InitializationException)

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_withJavaLangThrowable_(CucumberDepsComThoughtworksXstreamXStream_InitializationException *self, NSString *message, JavaLangThrowable *cause);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream_InitializationException *new_CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_withJavaLangThrowable_(NSString *message, JavaLangThrowable *cause) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream_InitializationException *create_CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_withJavaLangThrowable_(NSString *message, JavaLangThrowable *cause);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_(CucumberDepsComThoughtworksXstreamXStream_InitializationException *self, NSString *message);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream_InitializationException *new_CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_(NSString *message) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamXStream_InitializationException *create_CucumberDepsComThoughtworksXstreamXStream_InitializationException_initWithNSString_(NSString *message);

J2OBJC_TYPE_LITERAL_HEADER(CucumberDepsComThoughtworksXstreamXStream_InitializationException)
...
#endif
#pragma pop_macro("INCLUDE_ALL_CucumberDepsComThoughtworksXstreamXStream")
