...
@implementation CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype __nonnull)init {
  CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter = { "LongConverter", "cucumber.deps.com.thoughtworks.xstream.converters.basic", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter;
}

@end

void CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter_init(CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter *self) {
  CucumberDepsComThoughtworksXstreamConvertersBasicAbstractSingleValueConverter_init(self);
}

CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter *new_CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter_init() {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter, init)
}

CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter *create_CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter_init() {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamConvertersBasicLongConverter)
