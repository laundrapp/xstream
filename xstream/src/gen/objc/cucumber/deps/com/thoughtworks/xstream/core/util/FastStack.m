...
@interface CucumberDepsComThoughtworksXstreamCoreUtilFastStack () {
 @public
...
J2OBJC_FIELD_SETTER(CucumberDepsComThoughtworksXstreamCoreUtilFastStack, stack_, IOSObjectArray *)

__attribute__((unused)) static void CucumberDepsComThoughtworksXstreamCoreUtilFastStack_resizeStackWithInt_(CucumberDepsComThoughtworksXstreamCoreUtilFastStack *self, jint newCapacity);

@implementation CucumberDepsComThoughtworksXstreamCoreUtilFastStack

- (instancetype __nonnull)initWithInt:(jint)initialCapacity {
  CucumberDepsComThoughtworksXstreamCoreUtilFastStack_initWithInt_(self, initialCapacity);
  return self;
}

- (id)pushWithId:(id)value {
  if (pointer_ + 1 >= ((IOSObjectArray *) nil_chk(stack_))->size_) {
    CucumberDepsComThoughtworksXstreamCoreUtilFastStack_resizeStackWithInt_(self, stack_->size_ * 2);
  }
...
- (void)resizeStackWithInt:(jint)newCapacity {
  CucumberDepsComThoughtworksXstreamCoreUtilFastStack_resizeStackWithInt_(self, newCapacity);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamCoreUtilFastStack = { "FastStack", "cucumber.deps.com.thoughtworks.xstream.core.util", ptrTable, methods, fields, 7, 0x11, 12, 2, -1, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamCoreUtilFastStack;
}

@end

void CucumberDepsComThoughtworksXstreamCoreUtilFastStack_initWithInt_(CucumberDepsComThoughtworksXstreamCoreUtilFastStack *self, jint initialCapacity) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->stack_, [IOSObjectArray newArrayWithLength:initialCapacity type:NSObject_class_()]);
}

CucumberDepsComThoughtworksXstreamCoreUtilFastStack *new_CucumberDepsComThoughtworksXstreamCoreUtilFastStack_initWithInt_(jint initialCapacity) {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilFastStack, initWithInt_, initialCapacity)
}

CucumberDepsComThoughtworksXstreamCoreUtilFastStack *create_CucumberDepsComThoughtworksXstreamCoreUtilFastStack_initWithInt_(jint initialCapacity) {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilFastStack, initWithInt_, initialCapacity)
}

void CucumberDepsComThoughtworksXstreamCoreUtilFastStack_resizeStackWithInt_(CucumberDepsComThoughtworksXstreamCoreUtilFastStack *self, jint newCapacity) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamCoreUtilFastStack)
