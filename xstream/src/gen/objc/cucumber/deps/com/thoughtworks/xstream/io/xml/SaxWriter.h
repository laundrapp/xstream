...
#pragma push_macro("INCLUDE_ALL_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter")
#ifdef RESTRICT_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter
#define INCLUDE_ALL_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter 0
#else
#define INCLUDE_ALL_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter 1
#endif
#undef RESTRICT_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter
...
#if !defined (CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_) && (INCLUDE_ALL_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter || defined(INCLUDE_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter))
#define CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_
...
/*!
 ...
 <code>cucumber.deps.com.thoughtworks.xstream.io.HierarchicalStreamWriter</code> to enable direct generation of a
 ...
 */
@interface CucumberDepsComThoughtworksXstreamIoXmlSaxWriter : CucumberDepsComThoughtworksXstreamIoXmlAbstractXmlWriter < OrgXmlSaxXMLReader >
...
J2OBJC_EMPTY_STATIC_INIT(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter)
...
/*!
 @brief The <code>property</code> to configure the XStream
  ...
  parse.
 */
inline NSString *CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_get_CONFIGURED_XSTREAM_PROPERTY(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT NSString *CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_CONFIGURED_XSTREAM_PROPERTY;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter, CONFIGURED_XSTREAM_PROPERTY, NSString *)
...
/*!
 ...
 - seealso: #parse(org.xml.sax.InputSource)
 */
inline NSString *CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_get_SOURCE_OBJECT_LIST_PROPERTY(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT NSString *CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_SOURCE_OBJECT_LIST_PROPERTY;
J2OBJC_STATIC_FIELD_OBJ_FINAL(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter, SOURCE_OBJECT_LIST_PROPERTY, NSString *)

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self, id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self, jboolean includeEnclosingDocument, id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(jboolean includeEnclosingDocument, id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoNamingNameCoder_(jboolean includeEnclosingDocument, id<CucumberDepsComThoughtworksXstreamIoNamingNameCoder> nameCoder);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self, CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self, jboolean includeEnclosingDocument, CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(jboolean includeEnclosingDocument, CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_withCucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer_(jboolean includeEnclosingDocument, CucumberDepsComThoughtworksXstreamIoXmlXmlFriendlyReplacer *replacer);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self, jboolean includeEnclosingDocument);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_(jboolean includeEnclosingDocument) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_initWithBoolean_(jboolean includeEnclosingDocument);

FOUNDATION_EXPORT void CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_init(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *self);

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *new_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT CucumberDepsComThoughtworksXstreamIoXmlSaxWriter *create_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter_init(void);

J2OBJC_TYPE_LITERAL_HEADER(CucumberDepsComThoughtworksXstreamIoXmlSaxWriter)
...
#endif
#pragma pop_macro("INCLUDE_ALL_CucumberDepsComThoughtworksXstreamIoXmlSaxWriter")
