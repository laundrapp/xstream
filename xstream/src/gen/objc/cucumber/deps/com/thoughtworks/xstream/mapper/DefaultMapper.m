...
@interface CucumberDepsComThoughtworksXstreamMapperDefaultMapper () {
 @public
...
J2OBJC_FIELD_SETTER(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, classLoaderReference_, CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *)

inline NSString *CucumberDepsComThoughtworksXstreamMapperDefaultMapper_get_XSTREAM_PACKAGE_ROOT(void);
inline NSString *CucumberDepsComThoughtworksXstreamMapperDefaultMapper_set_XSTREAM_PACKAGE_ROOT(NSString *value);
static NSString *CucumberDepsComThoughtworksXstreamMapperDefaultMapper_XSTREAM_PACKAGE_ROOT;
J2OBJC_STATIC_FIELD_OBJ(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, XSTREAM_PACKAGE_ROOT, NSString *)

J2OBJC_INITIALIZED_DEFN(CucumberDepsComThoughtworksXstreamMapperDefaultMapper)

@implementation CucumberDepsComThoughtworksXstreamMapperDefaultMapper
...
- (instancetype __nonnull)initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference:(CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *)classLoaderReference {
  CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_(self, classLoaderReference);
  return self;
}

- (instancetype __nonnull)initWithJavaLangClassLoader:(JavaLangClassLoader *)classLoader {
  CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithJavaLangClassLoader_(self, classLoader);
  return self;
}
...
- (IOSClass *)realClassWithNSString:(NSString *)elementName {
  IOSClass *resultingClass = CucumberDepsComThoughtworksXstreamCoreUtilPrimitives_primitiveTypeWithNSString_(elementName);
  ...
  @try {
    ...
    if ([((NSString *) nil_chk(elementName)) java_hasPrefix:CucumberDepsComThoughtworksXstreamMapperDefaultMapper_XSTREAM_PACKAGE_ROOT]) {
      classLoader = [CucumberDepsComThoughtworksXstreamMapperDefaultMapper_class_() getClassLoader];
    }
    else {
      classLoader = [((CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *) nil_chk(classLoaderReference_)) getReference];
  ...
  @catch (JavaLangClassNotFoundException *e) {
    @throw create_CucumberDepsComThoughtworksXstreamMapperCannotResolveClassException_initWithNSString_(elementName);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LCucumberDepsComThoughtworksXstreamMapperMapper_ImplicitCollectionMapping;", 0x1, 15, 14, -1, -1, -1, -1 },
    ...
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 21, 5, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 22, 23, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 22, 3, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 22, 24, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersConverter;", 0x1, 25, 14, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamMapperMapper;", 0x1, 26, 3, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, 7, 14, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, 8, 14, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 21, 14, -1, -1, -1, -1 },
    { NULL, "LCucumberDepsComThoughtworksXstreamConvertersSingleValueConverter;", 0x1, 21, 27, -1, -1, -1, -1 },
  };
  ...
  static const void *ptrTable[] = { "LCucumberDepsComThoughtworksXstreamCoreClassLoaderReference;", "LJavaLangClassLoader;", "serializedClass", "LIOSClass;", "realClass", "LNSString;", "defaultImplementationOf", "aliasForAttribute", "attributeForAlias", "aliasForSystemAttribute", "isImmutableValueType", "getFieldNameForItemTypeAndName", "LIOSClass;LIOSClass;LNSString;", "getItemTypeForItemFieldName", "LIOSClass;LNSString;", "getImplicitCollectionDefForFieldName", "shouldSerializeMember", "lookupName", "lookupType", "serializedMember", "realMember", "getConverterFromAttribute", "getConverterFromItemType", "LNSString;LIOSClass;", "LNSString;LIOSClass;LIOSClass;", "getLocalConverter", "lookupMapperOfType", "LIOSClass;LNSString;LIOSClass;", &CucumberDepsComThoughtworksXstreamMapperDefaultMapper_XSTREAM_PACKAGE_ROOT };
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamMapperDefaultMapper = { "DefaultMapper", "cucumber.deps.com.thoughtworks.xstream.mapper", ptrTable, methods, fields, 7, 0x1, 27, 2, -1, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamMapperDefaultMapper;
}

+ (void)initialize {
  if (self == [CucumberDepsComThoughtworksXstreamMapperDefaultMapper class]) {
    {
      NSString *packageName = [CucumberDepsComThoughtworksXstreamMapperDefaultMapper_class_() getName];
      jint idx = [((NSString *) nil_chk(packageName)) java_indexOfString:@".xstream."];
      JreStrongAssign(&CucumberDepsComThoughtworksXstreamMapperDefaultMapper_XSTREAM_PACKAGE_ROOT, idx > 0 ? [packageName java_substring:0 endIndex:idx + 9] : @".N/A");
    }
    J2OBJC_SET_INITIALIZED(CucumberDepsComThoughtworksXstreamMapperDefaultMapper)
  }
}

@end

void CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_(CucumberDepsComThoughtworksXstreamMapperDefaultMapper *self, CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *classLoaderReference) {
  NSObject_init(self);
  JreStrongAssign(&self->classLoaderReference_, classLoaderReference);
}

CucumberDepsComThoughtworksXstreamMapperDefaultMapper *new_CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_(CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *classLoaderReference) {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_, classLoaderReference)
}

CucumberDepsComThoughtworksXstreamMapperDefaultMapper *create_CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_(CucumberDepsComThoughtworksXstreamCoreClassLoaderReference *classLoaderReference) {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_, classLoaderReference)
}

void CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithJavaLangClassLoader_(CucumberDepsComThoughtworksXstreamMapperDefaultMapper *self, JavaLangClassLoader *classLoader) {
  CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithCucumberDepsComThoughtworksXstreamCoreClassLoaderReference_(self, create_CucumberDepsComThoughtworksXstreamCoreClassLoaderReference_initWithJavaLangClassLoader_(classLoader));
}

CucumberDepsComThoughtworksXstreamMapperDefaultMapper *new_CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithJavaLangClassLoader_(JavaLangClassLoader *classLoader) {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, initWithJavaLangClassLoader_, classLoader)
}

CucumberDepsComThoughtworksXstreamMapperDefaultMapper *create_CucumberDepsComThoughtworksXstreamMapperDefaultMapper_initWithJavaLangClassLoader_(JavaLangClassLoader *classLoader) {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamMapperDefaultMapper, initWithJavaLangClassLoader_, classLoader)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamMapperDefaultMapper)
