...
@interface CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet () {
 @public
...
J2OBJC_FIELD_SETTER(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, list_, id<JavaUtilList>)
J2OBJC_FIELD_SETTER(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, comparator_, id<JavaUtilComparator>)

@implementation CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype __nonnull)init {
  CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype __nonnull)initWithJavaUtilComparator:(id<JavaUtilComparator>)comparator {
  CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_(self, comparator);
  return self;
}

- (instancetype __nonnull)initWithJavaUtilComparator:(id<JavaUtilComparator>)comparator
                              withJavaUtilCollection:(id<JavaUtilCollection>)c {
  CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_withJavaUtilCollection_(self, comparator, c);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet = { "PresortedSet", "cucumber.deps.com.thoughtworks.xstream.core.util", ptrTable, methods, fields, 7, 0x1, 25, 2, -1, -1, -1, -1, -1 };
  return &_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet;
}

@end

void CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_init(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *self) {
  CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_(self, nil);
}

CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *new_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_init() {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, init)
}

CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *create_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_init() {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, init)
}

void CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *self, id<JavaUtilComparator> comparator) {
  CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_withJavaUtilCollection_(self, comparator, nil);
}

CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *new_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_(id<JavaUtilComparator> comparator) {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, initWithJavaUtilComparator_, comparator)
}

CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *create_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_(id<JavaUtilComparator> comparator) {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, initWithJavaUtilComparator_, comparator)
}

void CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_withJavaUtilCollection_(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *self, id<JavaUtilComparator> comparator, id<JavaUtilCollection> c) {
  NSObject_init(self);
...
CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *new_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_withJavaUtilCollection_(id<JavaUtilComparator> comparator, id<JavaUtilCollection> c) {
  J2OBJC_NEW_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, initWithJavaUtilComparator_withJavaUtilCollection_, comparator, c)
}

CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet *create_CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet_initWithJavaUtilComparator_withJavaUtilCollection_(id<JavaUtilComparator> comparator, id<JavaUtilCollection> c) {
  J2OBJC_CREATE_IMPL(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet, initWithJavaUtilComparator_withJavaUtilCollection_, comparator, c)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(CucumberDepsComThoughtworksXstreamCoreUtilPresortedSet)
