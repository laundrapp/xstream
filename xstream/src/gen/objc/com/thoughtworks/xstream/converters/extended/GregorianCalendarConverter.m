...
withComThoughtworksXstreamConvertersMarshallingContext:(id<ComThoughtworksXstreamConvertersMarshallingContext>)context {
  ...
  [((id<ComThoughtworksXstreamIoHierarchicalStreamWriter>) nil_chk(writer)) setValueWithNSString:NSString_java_valueOfLong_(timeInMillis)];
  [writer endNode];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter = { "GregorianCalendarConverter", "com.thoughtworks.xstream.converters.extended", ptrTable, methods, NULL, 7, 0x1, 4, 0, -1, -1, -1, -1, -1 };
...
ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter *new_ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter_init() {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter, init)
}

ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter *create_ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter_init() {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamConvertersExtendedGregorianCalendarConverter, init)
}
