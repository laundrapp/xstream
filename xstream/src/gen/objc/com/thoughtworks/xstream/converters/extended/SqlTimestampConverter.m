...
- (NSString *)toStringWithId:(id)obj {
  ...
  JavaLangStringBuffer *buffer = [create_JavaLangStringBuffer_initWithNSString_([((ComThoughtworksXstreamCoreUtilThreadSafeSimpleDateFormat *) nil_chk(format_)) formatWithJavaUtilDate:timestamp]) appendWithChar:'.'];
...
- (id)fromStringWithNSString:(NSString *)str {
  ...
  @try {
    JavaSqlTimestamp *timestamp = create_JavaSqlTimestamp_initWithLong_([((JavaUtilDate *) nil_chk([((ComThoughtworksXstreamCoreUtilThreadSafeSimpleDateFormat *) nil_chk(format_)) parseWithNSString:[str java_substring:0 endIndex:idx]])) getTime]);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "format_", "LComThoughtworksXstreamCoreUtilThreadSafeSimpleDateFormat;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "canConvert", "LIOSClass;", "toString", "LNSObject;", "fromString", "LNSString;" };
  static const J2ObjcClassInfo _ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter = { "SqlTimestampConverter", "com.thoughtworks.xstream.converters.extended", ptrTable, methods, fields, 7, 0x1, 4, 1, -1, -1, -1, -1, -1 };
...
void ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter_init(ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter *self) {
  ...
  JreStrongAssignAndConsume(&self->format_, new_ComThoughtworksXstreamCoreUtilThreadSafeSimpleDateFormat_initWithNSString_withJavaUtilTimeZone_withInt_withInt_withBoolean_(@"yyyy-MM-dd HH:mm:ss", JavaUtilTimeZone_getTimeZoneWithNSString_(@"UTC"), 0, 5, false));
}
...
ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter *new_ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter_init() {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter, init)
}

ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter *create_ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter_init() {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamConvertersExtendedSqlTimestampConverter, init)
}
