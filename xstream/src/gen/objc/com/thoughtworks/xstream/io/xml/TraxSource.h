...
#pragma push_macro("INCLUDE_ALL_ComThoughtworksXstreamIoXmlTraxSource")
#ifdef RESTRICT_ComThoughtworksXstreamIoXmlTraxSource
#define INCLUDE_ALL_ComThoughtworksXstreamIoXmlTraxSource 0
#else
#define INCLUDE_ALL_ComThoughtworksXstreamIoXmlTraxSource 1
#endif
#undef RESTRICT_ComThoughtworksXstreamIoXmlTraxSource
...
#if !defined (ComThoughtworksXstreamIoXmlTraxSource_) && (INCLUDE_ALL_ComThoughtworksXstreamIoXmlTraxSource || defined(INCLUDE_ComThoughtworksXstreamIoXmlTraxSource))
#define ComThoughtworksXstreamIoXmlTraxSource_
 ...
 */
@interface ComThoughtworksXstreamIoXmlTraxSource : JavaxXmlTransformSaxSAXSource
...
/*!
 ...
 - seealso: #setSourceAsList(java.util.List)
 - seealso: #setXStream(com.thoughtworks.xstream.XStream)
 */
- (instancetype __nonnull)initWithJavaUtilList:(id<JavaUtilList>)source
...
J2OBJC_EMPTY_STATIC_INIT(ComThoughtworksXstreamIoXmlTraxSource)
 ...
 */
inline NSString *ComThoughtworksXstreamIoXmlTraxSource_get_XSTREAM_FEATURE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT NSString *ComThoughtworksXstreamIoXmlTraxSource_XSTREAM_FEATURE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComThoughtworksXstreamIoXmlTraxSource, XSTREAM_FEATURE, NSString *)

FOUNDATION_EXPORT void ComThoughtworksXstreamIoXmlTraxSource_init(ComThoughtworksXstreamIoXmlTraxSource *self);

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *new_ComThoughtworksXstreamIoXmlTraxSource_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *create_ComThoughtworksXstreamIoXmlTraxSource_init(void);

FOUNDATION_EXPORT void ComThoughtworksXstreamIoXmlTraxSource_initWithId_(ComThoughtworksXstreamIoXmlTraxSource *self, id source);

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *new_ComThoughtworksXstreamIoXmlTraxSource_initWithId_(id source) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *create_ComThoughtworksXstreamIoXmlTraxSource_initWithId_(id source);

FOUNDATION_EXPORT void ComThoughtworksXstreamIoXmlTraxSource_initWithId_withComThoughtworksXstreamXStream_(ComThoughtworksXstreamIoXmlTraxSource *self, id source, ComThoughtworksXstreamXStream *xstream);

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *new_ComThoughtworksXstreamIoXmlTraxSource_initWithId_withComThoughtworksXstreamXStream_(id source, ComThoughtworksXstreamXStream *xstream) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *create_ComThoughtworksXstreamIoXmlTraxSource_initWithId_withComThoughtworksXstreamXStream_(id source, ComThoughtworksXstreamXStream *xstream);

FOUNDATION_EXPORT void ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_(ComThoughtworksXstreamIoXmlTraxSource *self, id<JavaUtilList> source);

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *new_ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_(id<JavaUtilList> source) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *create_ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_(id<JavaUtilList> source);

FOUNDATION_EXPORT void ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_withComThoughtworksXstreamXStream_(ComThoughtworksXstreamIoXmlTraxSource *self, id<JavaUtilList> source, ComThoughtworksXstreamXStream *xstream);

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *new_ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_withComThoughtworksXstreamXStream_(id<JavaUtilList> source, ComThoughtworksXstreamXStream *xstream) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamIoXmlTraxSource *create_ComThoughtworksXstreamIoXmlTraxSource_initWithJavaUtilList_withComThoughtworksXstreamXStream_(id<JavaUtilList> source, ComThoughtworksXstreamXStream *xstream);

J2OBJC_TYPE_LITERAL_HEADER(ComThoughtworksXstreamIoXmlTraxSource)
...
#endif
#pragma pop_macro("INCLUDE_ALL_ComThoughtworksXstreamIoXmlTraxSource")
