...
#include "com/thoughtworks/xstream/io/xml/QNameMap.h"
#include "java/util/Collections.h"
#include "java/util/HashMap.h"
#include "java/util/Map.h"
#include "javax/xml/namespace/QName.h"

@interface ComThoughtworksXstreamIoXmlQNameMap () {
 @public
...
J2OBJC_FIELD_SETTER(ComThoughtworksXstreamIoXmlQNameMap, qnameToJava_, id<JavaUtilMap>)
J2OBJC_FIELD_SETTER(ComThoughtworksXstreamIoXmlQNameMap, javaToQName_, id<JavaUtilMap>)
J2OBJC_FIELD_SETTER(ComThoughtworksXstreamIoXmlQNameMap, defaultPrefix_, NSString *)
J2OBJC_FIELD_SETTER(ComThoughtworksXstreamIoXmlQNameMap, defaultNamespace_, NSString *)

@implementation ComThoughtworksXstreamIoXmlQNameMap

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype __nonnull)init {
  ComThoughtworksXstreamIoXmlQNameMap_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComThoughtworksXstreamIoXmlQNameMap = { "QNameMap", "com.thoughtworks.xstream.io.xml", ptrTable, methods, fields, 7, 0x1, 9, 4, -1, -1, -1, -1, -1 };
  return &_ComThoughtworksXstreamIoXmlQNameMap;
}

@end

void ComThoughtworksXstreamIoXmlQNameMap_init(ComThoughtworksXstreamIoXmlQNameMap *self) {
  NSObject_init(self);
  JreStrongAssign(&self->defaultPrefix_, @"");
  JreStrongAssign(&self->defaultNamespace_, @"");
}

ComThoughtworksXstreamIoXmlQNameMap *new_ComThoughtworksXstreamIoXmlQNameMap_init() {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamIoXmlQNameMap, init)
}

ComThoughtworksXstreamIoXmlQNameMap *create_ComThoughtworksXstreamIoXmlQNameMap_init() {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamIoXmlQNameMap, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ComThoughtworksXstreamIoXmlQNameMap)
