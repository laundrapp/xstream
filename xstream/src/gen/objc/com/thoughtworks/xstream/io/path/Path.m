...
inline ComThoughtworksXstreamIoPathPath *ComThoughtworksXstreamIoPathPath_get_DOT(void);
static ComThoughtworksXstreamIoPathPath *ComThoughtworksXstreamIoPathPath_DOT;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComThoughtworksXstreamIoPathPath, DOT, ComThoughtworksXstreamIoPathPath *)
...
- (jboolean)isEqual:(id)o {
  ...
  if (!([o isKindOfClass:[ComThoughtworksXstreamIoPathPath class]])) return false;
  ComThoughtworksXstreamIoPathPath *other = (ComThoughtworksXstreamIoPathPath *) cast_chk(o, [ComThoughtworksXstreamIoPathPath class]);
  if (((IOSObjectArray *) nil_chk(chunks_))->size_ != ((ComThoughtworksXstreamIoPathPath *) nil_chk(other))->chunks_->size_) return false;
...
- (ComThoughtworksXstreamIoPathPath *)relativeToWithComThoughtworksXstreamIoPathPath:(ComThoughtworksXstreamIoPathPath *)that {
  ...
  if (count == 0) {
    return ComThoughtworksXstreamIoPathPath_DOT;
  }
  else {
    return create_ComThoughtworksXstreamIoPathPath_initWithNSStringArray_(result);
  }
}
...
- (ComThoughtworksXstreamIoPathPath *)applyWithComThoughtworksXstreamIoPathPath:(ComThoughtworksXstreamIoPathPath *)relativePath {
  ComThoughtworksXstreamCoreUtilFastStack *absoluteStack = create_ComThoughtworksXstreamCoreUtilFastStack_initWithInt_(16);
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(chunks_))->size_; i++) {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComThoughtworksXstreamIoPathPath;", 0x1, 9, 10, -1, -1, -1, -1 },
    { NULL, "I", 0x2, 11, 12, -1, -1, -1, -1 },
    { NULL, "LComThoughtworksXstreamIoPathPath;", 0x1, 13, 10, -1, -1, -1, -1 },
  ...
  methods[7].selector = @selector(relativeToWithComThoughtworksXstreamIoPathPath:);
  methods[8].selector = @selector(depthOfPathDivergenceWithNSStringArray:withNSStringArray:);
  methods[9].selector = @selector(applyWithComThoughtworksXstreamIoPathPath:);
  methods[10].selector = @selector(isAncestorWithComThoughtworksXstreamIoPathPath:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "DOT", "LComThoughtworksXstreamIoPathPath;", .constantValue.asLong = 0, 0x1a, -1, 15, -1, -1 },
  };
  static const void *ptrTable[] = { "LNSString;", "normalize", "LNSString;II", "[LNSString;", "toString", "explicit", "equals", "LNSObject;", "hashCode", "relativeTo", "LComThoughtworksXstreamIoPathPath;", "depthOfPathDivergence", "[LNSString;[LNSString;", "apply", "isAncestor", &ComThoughtworksXstreamIoPathPath_DOT };
  static const J2ObjcClassInfo _ComThoughtworksXstreamIoPathPath = { "Path", "com.thoughtworks.xstream.io.path", ptrTable, methods, fields, 7, 0x1, 11, 4, -1, -1, -1, -1, -1 };
  return &_ComThoughtworksXstreamIoPathPath;
}

+ (void)initialize {
  if (self == [ComThoughtworksXstreamIoPathPath class]) {
    JreStrongAssignAndConsume(&ComThoughtworksXstreamIoPathPath_DOT, new_ComThoughtworksXstreamIoPathPath_initWithNSStringArray_([IOSObjectArray arrayWithObjects:(id[]){ @"." } count:1 type:NSString_class_()]));
...
void ComThoughtworksXstreamIoPathPath_initWithNSString_(ComThoughtworksXstreamIoPathPath *self, NSString *pathAsString) {
  ...
  [result addWithId:ComThoughtworksXstreamIoPathPath_normalizeWithNSString_withInt_withInt_(self, pathAsString, currentIndex, [pathAsString java_length])];
...
ComThoughtworksXstreamIoPathPath *new_ComThoughtworksXstreamIoPathPath_initWithNSString_(NSString *pathAsString) {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamIoPathPath, initWithNSString_, pathAsString)
}

ComThoughtworksXstreamIoPathPath *create_ComThoughtworksXstreamIoPathPath_initWithNSString_(NSString *pathAsString) {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamIoPathPath, initWithNSString_, pathAsString)
}
...
ComThoughtworksXstreamIoPathPath *new_ComThoughtworksXstreamIoPathPath_initWithNSStringArray_(IOSObjectArray *chunks) {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamIoPathPath, initWithNSStringArray_, chunks)
}

ComThoughtworksXstreamIoPathPath *create_ComThoughtworksXstreamIoPathPath_initWithNSStringArray_(IOSObjectArray *chunks) {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamIoPathPath, initWithNSStringArray_, chunks)
}
