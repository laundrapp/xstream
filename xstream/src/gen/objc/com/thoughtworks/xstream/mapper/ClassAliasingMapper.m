...
__attribute__((unused)) static id ComThoughtworksXstreamMapperClassAliasingMapper_readResolve(ComThoughtworksXstreamMapperClassAliasingMapper *self);
...
- (id)readResolve {
  return ComThoughtworksXstreamMapperClassAliasingMapper_readResolve(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LComThoughtworksXstreamMapperMapper;", "addClassAlias", "LNSString;LIOSClass;", "addClassAttributeAlias", "addTypeAlias", "serializedClass", "LIOSClass;", "realClass", "LNSString;", "itemTypeAsAttribute", "aliasIsAttribute" };
  static const J2ObjcClassInfo _ComThoughtworksXstreamMapperClassAliasingMapper = { "ClassAliasingMapper", "com.thoughtworks.xstream.mapper", ptrTable, methods, fields, 7, 0x1, 9, 3, -1, -1, -1, -1, -1 };
...
ComThoughtworksXstreamMapperClassAliasingMapper *new_ComThoughtworksXstreamMapperClassAliasingMapper_initWithComThoughtworksXstreamMapperMapper_(id<ComThoughtworksXstreamMapperMapper> wrapped) {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamMapperClassAliasingMapper, initWithComThoughtworksXstreamMapperMapper_, wrapped)
}

ComThoughtworksXstreamMapperClassAliasingMapper *create_ComThoughtworksXstreamMapperClassAliasingMapper_initWithComThoughtworksXstreamMapperMapper_(id<ComThoughtworksXstreamMapperMapper> wrapped) {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamMapperClassAliasingMapper, initWithComThoughtworksXstreamMapperMapper_, wrapped)
}

id ComThoughtworksXstreamMapperClassAliasingMapper_readResolve(ComThoughtworksXstreamMapperClassAliasingMapper *self) {
  JreStrongAssignAndConsume(&self->nameToType_, new_JavaUtilHashMap_init());
