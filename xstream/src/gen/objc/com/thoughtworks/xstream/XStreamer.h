...
#pragma push_macro("INCLUDE_ALL_ComThoughtworksXstreamXStreamer")
#ifdef RESTRICT_ComThoughtworksXstreamXStreamer
#define INCLUDE_ALL_ComThoughtworksXstreamXStreamer 0
#else
#define INCLUDE_ALL_ComThoughtworksXstreamXStreamer 1
#endif
#undef RESTRICT_ComThoughtworksXstreamXStreamer
...
#if !defined (ComThoughtworksXstreamXStreamer_) && (INCLUDE_ALL_ComThoughtworksXstreamXStreamer || defined(INCLUDE_ComThoughtworksXstreamXStreamer))
#define ComThoughtworksXstreamXStreamer_
...
/*!
 ...
 @throw com.thoughtworks.xstream.XStreamExceptionif the object cannot be deserialized
 @since 1.2
 */
...
/*!
 ...
 @throw com.thoughtworks.xstream.XStreamExceptionif the object cannot be serialized
 @since 1.2
 - seealso: #toXML(XStream, Object, Writer)
 */
...
FOUNDATION_EXPORT ComThoughtworksXstreamXStreamer *new_ComThoughtworksXstreamXStreamer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComThoughtworksXstreamXStreamer *create_ComThoughtworksXstreamXStreamer_init(void);

FOUNDATION_EXPORT IOSObjectArray *ComThoughtworksXstreamXStreamer_getDefaultPermissions(void);
...
#endif
#pragma pop_macro("INCLUDE_ALL_ComThoughtworksXstreamXStreamer")
