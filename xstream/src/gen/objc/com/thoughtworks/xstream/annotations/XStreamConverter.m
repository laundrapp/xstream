...
__attribute__((unused)) static IOSObjectArray *ComThoughtworksXstreamAnnotationsXStreamConverter__Annotations$0(void);
...
- (NSString *)description {
  return [NSString stringWithFormat:@"@com.thoughtworks.xstream.annotations.XStreamConverter(value=%@, priority=%d, useImplicitType=%d, types=%@, strings=%@, bytes=%@, chars=%@, shorts=%@, ints=%@, longs=%@, floats=%@, doubles=%@, booleans=%@)", value_, priority_, useImplicitType_, types_, strings_, bytes_, chars_, shorts_, ints_, longs_, floats_, doubles_, booleans_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "Ljava/lang/Class<+Lcom/thoughtworks/xstream/converters/ConverterMatcher;>;", "[Ljava/lang/Class<*>;", (void *)&ComThoughtworksXstreamAnnotationsXStreamConverter__Annotations$0 };
  static const J2ObjcClassInfo _ComThoughtworksXstreamAnnotationsXStreamConverter = { "XStreamConverter", "com.thoughtworks.xstream.annotations", ptrTable, methods, fields, 7, 0x2609, 13, 13, -1, -1, -1, -1, 2 };
...
id<ComThoughtworksXstreamAnnotationsXStreamConverter> create_ComThoughtworksXstreamAnnotationsXStreamConverter(IOSBooleanArray *booleans, IOSByteArray *bytes, IOSCharArray *chars, IOSDoubleArray *doubles, IOSFloatArray *floats, IOSIntArray *ints, IOSLongArray *longs, jint priority, IOSShortArray *shorts, IOSObjectArray *strings, IOSObjectArray *types, jboolean useImplicitType, IOSClass *value) {
  ComThoughtworksXstreamAnnotationsXStreamConverter *self = AUTORELEASE([[ComThoughtworksXstreamAnnotationsXStreamConverter alloc] init]);
...
IOSObjectArray *ComThoughtworksXstreamAnnotationsXStreamConverter__Annotations$0() {
