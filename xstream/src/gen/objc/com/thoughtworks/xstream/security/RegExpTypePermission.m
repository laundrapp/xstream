...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComThoughtworksXstreamSecurityRegExpTypePermission = { "RegExpTypePermission", "com.thoughtworks.xstream.security", ptrTable, methods, fields, 7, 0x1, 4, 1, -1, -1, -1, -1, -1 };
...
void ComThoughtworksXstreamSecurityRegExpTypePermission_initWithNSStringArray_(ComThoughtworksXstreamSecurityRegExpTypePermission *self, IOSObjectArray *patterns) {
  ComThoughtworksXstreamSecurityRegExpTypePermission_initWithJavaUtilRegexPatternArray_(self, ComThoughtworksXstreamSecurityRegExpTypePermission_getPatternsWithNSStringArray_(patterns));
}
...
ComThoughtworksXstreamSecurityRegExpTypePermission *new_ComThoughtworksXstreamSecurityRegExpTypePermission_initWithNSStringArray_(IOSObjectArray *patterns) {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamSecurityRegExpTypePermission, initWithNSStringArray_, patterns)
}

ComThoughtworksXstreamSecurityRegExpTypePermission *create_ComThoughtworksXstreamSecurityRegExpTypePermission_initWithNSStringArray_(IOSObjectArray *patterns) {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamSecurityRegExpTypePermission, initWithNSStringArray_, patterns)
}
...
ComThoughtworksXstreamSecurityRegExpTypePermission *new_ComThoughtworksXstreamSecurityRegExpTypePermission_initWithJavaUtilRegexPatternArray_(IOSObjectArray *patterns) {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamSecurityRegExpTypePermission, initWithJavaUtilRegexPatternArray_, patterns)
}

ComThoughtworksXstreamSecurityRegExpTypePermission *create_ComThoughtworksXstreamSecurityRegExpTypePermission_initWithJavaUtilRegexPatternArray_(IOSObjectArray *patterns) {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamSecurityRegExpTypePermission, initWithJavaUtilRegexPatternArray_, patterns)
}
