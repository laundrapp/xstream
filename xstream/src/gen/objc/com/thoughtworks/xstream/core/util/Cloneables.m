...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComThoughtworksXstreamCoreUtilCloneables = { "Cloneables", "com.thoughtworks.xstream.core.util", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
...
ComThoughtworksXstreamCoreUtilCloneables *new_ComThoughtworksXstreamCoreUtilCloneables_init() {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamCoreUtilCloneables, init)
}

ComThoughtworksXstreamCoreUtilCloneables *create_ComThoughtworksXstreamCoreUtilCloneables_init() {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamCoreUtilCloneables, init)
}
  ...
  if ([NSCopying_class_() isInstance:o]) {
    if ([[nil_chk(o) java_getClass] isArray]) {
      ...
      @catch (JavaLangNoSuchMethodException *e) {
        @throw create_ComThoughtworksXstreamConvertersReflectionObjectAccessException_initWithNSString_withJavaLangThrowable_(@"Cloneable type has no clone method", e);
      }
      @catch (JavaLangIllegalAccessException *e) {
        @throw create_ComThoughtworksXstreamConvertersReflectionObjectAccessException_initWithNSString_withJavaLangThrowable_(@"Cannot clone Cloneable type", e);
      }
      @catch (JavaLangReflectInvocationTargetException *e) {
        @throw create_ComThoughtworksXstreamConvertersReflectionObjectAccessException_initWithNSString_withJavaLangThrowable_(@"Exception cloning Cloneable type", [e getCause]);
      }
    }
  }
  return nil;
