...
inline IOSCharArray *ComThoughtworksXstreamCoreUtilBase64Encoder_get_SIXTY_FOUR_CHARS(void);
static IOSCharArray *ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComThoughtworksXstreamCoreUtilBase64Encoder, SIXTY_FOUR_CHARS, IOSCharArray *)

inline IOSIntArray *ComThoughtworksXstreamCoreUtilBase64Encoder_get_REVERSE_MAPPING(void);
static IOSIntArray *ComThoughtworksXstreamCoreUtilBase64Encoder_REVERSE_MAPPING;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComThoughtworksXstreamCoreUtilBase64Encoder, REVERSE_MAPPING, IOSIntArray *)
...
- (NSString *)encodeWithByteArray:(IOSByteArray *)input {
  ...
  for (jint i = 0; i < ((IOSByteArray *) nil_chk(input))->size_; i += 3) {
    ...
    for (jint j = 0; j < 4; j++) [result appendWithChar:remaining + 1 > j ? IOSCharArray_Get(nil_chk(ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS), (jint) 0x3f & (JreRShift32(oneBigNumber, 6 * (3 - j)))) : '='];
...
- (IOSByteArray *)decodeWithNSString:(NSString *)input {
  @try {
    ...
    for (jint i = 0; i < [((NSString *) nil_chk(input)) java_length]; i += 4) {
      IOSIntArray *a = [IOSIntArray arrayWithInts:(jint[]){ ComThoughtworksXstreamCoreUtilBase64Encoder_mapCharToIntWithJavaIoReader_(self, in), ComThoughtworksXstreamCoreUtilBase64Encoder_mapCharToIntWithJavaIoReader_(self, in), ComThoughtworksXstreamCoreUtilBase64Encoder_mapCharToIntWithJavaIoReader_(self, in), ComThoughtworksXstreamCoreUtilBase64Encoder_mapCharToIntWithJavaIoReader_(self, in) } count:4];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "encode", "[B", "decode", "LNSString;", "mapCharToInt", "LJavaIoReader;", "LJavaIoIOException;", &ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS, &ComThoughtworksXstreamCoreUtilBase64Encoder_REVERSE_MAPPING };
  static const J2ObjcClassInfo _ComThoughtworksXstreamCoreUtilBase64Encoder = { "Base64Encoder", "com.thoughtworks.xstream.core.util", ptrTable, methods, fields, 7, 0x1, 4, 2, -1, -1, -1, -1, -1 };
  return &_ComThoughtworksXstreamCoreUtilBase64Encoder;
}

+ (void)initialize {
  if (self == [ComThoughtworksXstreamCoreUtilBase64Encoder class]) {
    JreStrongAssign(&ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS, [@"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" java_toCharArray]);
    JreStrongAssignAndConsume(&ComThoughtworksXstreamCoreUtilBase64Encoder_REVERSE_MAPPING, [IOSIntArray newArrayWithLength:123]);
    {
      for (jint i = 0; i < ((IOSCharArray *) nil_chk(ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS))->size_; i++) *IOSIntArray_GetRef(ComThoughtworksXstreamCoreUtilBase64Encoder_REVERSE_MAPPING, IOSCharArray_Get(ComThoughtworksXstreamCoreUtilBase64Encoder_SIXTY_FOUR_CHARS, i)) = i + 1;
    }
...
ComThoughtworksXstreamCoreUtilBase64Encoder *new_ComThoughtworksXstreamCoreUtilBase64Encoder_init() {
  J2OBJC_NEW_IMPL(ComThoughtworksXstreamCoreUtilBase64Encoder, init)
}

ComThoughtworksXstreamCoreUtilBase64Encoder *create_ComThoughtworksXstreamCoreUtilBase64Encoder_init() {
  J2OBJC_CREATE_IMPL(ComThoughtworksXstreamCoreUtilBase64Encoder, init)
}
...
jint ComThoughtworksXstreamCoreUtilBase64Encoder_mapCharToIntWithJavaIoReader_(ComThoughtworksXstreamCoreUtilBase64Encoder *self, JavaIoReader *input) {
  ...
  while ((c = [((JavaIoReader *) nil_chk(input)) read]) != -1) {
    jint result = IOSIntArray_Get(nil_chk(ComThoughtworksXstreamCoreUtilBase64Encoder_REVERSE_MAPPING), c);
